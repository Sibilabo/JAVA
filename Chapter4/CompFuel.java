/*Wprowadza metodę z parametrem 
obliczającą paliwo potrzebne
do przejechania podanego dystansu
*/
...
class Vehicle {
    ...
    //Oblicza paliwo do przejechania km kilometrów
...
class CompFuel {
    public static void main(String args[]) {
        ...
        //Przypisuje wartość składowym obiektu minivan
        minivan.passengers = 7;
        minivan.fuelcap = 65;
        minivan.lkm = 9.1;

        //Przypisuje wartość składowym obiektu sportscar
